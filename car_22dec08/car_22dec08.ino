...
void setup() {
  ...
  str_length20_1.reserve(16);
  str_length20_2.reserve(16);
  str_length20_3.reserve(16);
  str_length20_4.reserve(16);
...
//  oled.begin(&Adafruit128x32, I2C_ADDRESS);
  ...
  str_length20_1 = F("Veer Car2b"); //
  str_length20_2 = F("Setup complete");
  displaytext(0);
...
//      str_length20_2 = str_length20_2 + " D:" + curDist;
      str_length20_2 = "Th:  St:  D:" + curDist;
...
void displaytext(int idx) {
  ...
  if(idx == COLL_DIST) {
    ...
    oled.set1X();
    oled.println("move() 0 0"/*str_length20_4*/);
  }
}
//-------------------------------------------------------------------------------------------------------------------------------------
void playtone(int numoftones) {
